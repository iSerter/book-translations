...
- [ ] T024 [P] [US1] Add small book fixture JSON in tests/fixtures/us1_book_small.json
- [ ] T025 [US1] Add CLI test for storing a book in tests/cli/us1_book_store.test.ts
- [ ] T026 [P] [US1] Add integration test for idempotent chapter insert behavior in tests/integration/us1_store_book_idempotent.test.ts

### Implementation for User Story 1

- [ ] T027 [P] [US1] Define Book/Chapter/Verse TypeScript types in src/models/domain.ts
- [ ] T028 [US1] Implement store-book service (transactional insert/upsert) in src/services/book_service.ts
- [ ] T029 [US1] Implement `book store` command (file/stdin input, validation, --json output) in src/cli/commands/book.ts
- [ ] T030 [US1] Wire `book` commands into src/cli/index.ts
- [ ] T031 [US1] Ensure DB constraints + service logic prevent invalid chapter/verse numbers (FR-005) in src/services/book_service.ts
...
- [ ] T032 [P] [US2] Add unit tests for generated chapter validation rules in tests/unit/us2_chapter_package_validator.test.ts
- [ ] T033 [P] [US2] Add CLI test for chapter generation with resume in tests/cli/us2_chapter_generate_resume.test.ts
- [ ] T034 [P] [US2] Add CLI test for rejecting invalid generated output without overwriting stored data in tests/cli/us2_chapter_generate_reject_invalid.test.ts

### Implementation for User Story 2

- [ ] T035 [P] [US2] Implement chapter package validator (sequential numbering, expected count) in src/services/chapter_package_validator.ts
- [ ] T036 [P] [US2] Implement prompt template storage service in src/services/prompt_template_service.ts
- [ ] T037 [US2] Implement `template add` and `template get` commands in src/cli/commands/template.ts

- [ ] T038 [P] [US2] Define generation provider interface in src/providers/generation_provider.ts
- [ ] T039 [P] [US2] Implement deterministic fake generation provider for tests in src/providers/fake_generation_provider.ts
- [ ] T040 [US2] Register generation providers (fake + ai-sdk) in src/providers/provider_registry.ts
- [ ] T041 [US2] Implement ai-sdk generation provider wrapper with timeouts/retries in src/providers/ai_sdk_generation_provider.ts

- [ ] T042 [US2] Implement generation-run persistence (start/update/complete/fail) in src/services/generation_run_service.ts
- [ ] T043 [US2] Implement chapter generation orchestrator (resume from verse, store progress) in src/services/chapter_generation_service.ts
- [ ] T044 [US2] Implement `chapter generate` command in src/cli/commands/chapter.ts
- [ ] T045 [US2] Wire `template` and `chapter` commands into src/cli/index.ts
...
- [ ] T046 [P] [US3] Add CLI test for translating a verse using fake provider in tests/cli/us3_verse_translate.test.ts
- [ ] T047 [P] [US3] Add CLI test for duplicate translation behavior (refuse vs overwrite flag) in tests/cli/us3_duplicate_translation_policy.test.ts
- [ ] T048 [P] [US3] Add CLI test ensuring provider failures do not overwrite existing translations in tests/cli/us3_provider_failure_no_corruption.test.ts

### Implementation for User Story 3

- [ ] T049 [P] [US3] Define translation provider interface in src/providers/translation_provider.ts
- [ ] T050 [P] [US3] Implement deterministic fake translation provider for tests in src/providers/fake_translation_provider.ts
- [ ] T051 [P] [US3] Implement DeepL translation provider wrapper in src/providers/deepl_translation_provider.ts
- [ ] T052 [P] [US3] Implement AI-SDK-as-translator provider wrapper in src/providers/ai_sdk_translation_provider.ts
- [ ] T053 [US3] Register translation providers in src/providers/provider_registry.ts

- [ ] T054 [US3] Implement translation service (fetch verses, call provider, store results, handle duplicates) in src/services/translation_service.ts
- [ ] T055 [US3] Implement `verse translate` command (multiple verses, --overwrite, --json) in src/cli/commands/verse.ts
- [ ] T056 [US3] Wire `verse` commands into src/cli/index.ts
...
- [ ] T057 [P] [US4] Add CLI test for retrieving translations in tests/cli/us4_translations_get.test.ts
- [ ] T058 [P] [US4] Add CLI test for non-existent verse returning empty results in tests/cli/us4_translations_get_missing.test.ts

### Implementation for User Story 4

- [ ] T059 [US4] Implement translations query service in src/services/translations_query_service.ts
- [ ] T060 [US4] Implement `translations get` command in src/cli/commands/translations.ts
- [ ] T061 [US4] Wire `translations` commands into src/cli/index.ts
...
- [ ] T062 [P] Update documentation for env vars and providers in README.md
- [ ] T063 Update quickstart commands to match implemented CLI in specs/001-book-translation-app/quickstart.md
- [ ] T064 Add performance check for bulk insert (SC-001) in tests/integration/perf_us1_bulk_insert_smoke.test.ts
- [ ] T065 Add end-to-end smoke test covering US1→US4 flow in tests/cli/e2e_smoke_us1_us4.test.ts
